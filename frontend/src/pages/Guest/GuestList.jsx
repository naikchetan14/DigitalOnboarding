...
import { deleteCurrentGuest, getAllGuestList } from "../../Actions/guestAction/guestActions";
...
{viewGuestDetails && (
        <div className="modal fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-75 z-50">
          <div className="modal-content bg-white p-8 rounded-md shadow-lg">
            ...
            <p><strong>Hotel Name:</strong> {viewGuestDetails?.hotelId?.hotelName}</p>
            <p><strong>Hotel Logo:</strong></p>
            <img
              src={viewGuestDetails?.hotelId?.logo}
              alt="Hotel Logo"
              className="w-[100px] object-cover rounded-sm mb-4"
            />
            <p><strong>Address:</strong> {viewGuestDetails.address}</p>
            <p><strong>purposeOfVisit:</strong> {viewGuestDetails.purposeOfVisit}</p>

            <p><strong>Guest Name:</strong> {viewGuestDetails.fullName}</p>
            <p><strong>Guest Stay From:</strong> {viewGuestDetails.stayFrom.substring(0, 10)}</p>
            <p><strong>Guest Stay To:</strong> {viewGuestDetails.stayTo.substring(0, 10)}</p>
            <p><strong>Email:</strong> {viewGuestDetails.email}</p>
            <p><strong>Mobile:</strong> {viewGuestDetails.mobileNumber}</p>
